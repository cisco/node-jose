...
var base64url = {
  ...
  encode: function encode(buffer, encoding) {
     ...
     * @function
     *
     * Checks ArrayBuffer instanceof without identity discontinuity.
     *
     * @param {Object} object to test
     * @param {typeToCheck|ArrayBuffer} type to check
     * @returns {Boolean} returns whether object to test is type of typeToCheck or not.
     *
     */
    var checkDeepPrototype = function(objectToTest, typeToCheck) {
    ...
    if (checkDeepPrototype(buffer, ArrayBuffer)) {
