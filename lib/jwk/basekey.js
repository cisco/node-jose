...
var JWKBaseKeyObject = function(kty, ks, props, cfg) {
  ...
  /**
   * @method JWK.Key#toDER
   * @description
   * Returns the DER representation of this Key as a Buffer.
   *
   * @param {Boolean} [isPrivate=false] `true` if private parameters should be
   *        included.
   * @returns {Buffer} The DER-encoded Buffer
   */
  Object.defineProperty(this, "toDER", {
    value: function(isPrivate) {
      if (isPrivate === null) {
        isPrivate = false;
      }
      ...
      return cfg.convertToDER.call(this, k, isPrivate);
    }
  });
