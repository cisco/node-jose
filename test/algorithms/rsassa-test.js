...
describe("algorithms/rsassa", function() {
  var vectors = [
    // 2048-bit; RSASSA-PKCS-V1_5; SHA-256
    {
      alg: "RS256",
      desc: "RSASSA-PKCS1-V1_5 with SHA-256",
      key: {
        "kty": "RSA",
    ...
    {
      alg: "RS384",
      desc: "RSASSA-PKCS1-V_5 with SHA-384",
      key: {
        "kty": "RSA",
        "n": util.base64url.decode("tHxy-fcpeVkvyncpt0xiMRvmKkpLzvd58AFpjHc4fUAqPgIGB7W4TBwTLWFB86p70ZwWYAcZtlxDS5xIfTFSh5sQp9Fw6DK45Jsjqho4WSkx88vrHtHSgIYepyqN88TjOMZnMpArZe1MaWt8jMLq2zia8V07XZx8j33iIKB_cSUcyNaiFYX9xthxiMJT4fAP8mer0N2GMhQnZcucltV9aHN-aMs0srsFpoiWtGFVmW72wF5EAJ-lMConfiImADGnyO6kuhRSsz39_3u3Q7kpcj757-cmCp4pUKn4vROCt3v-Rj_OHmNG5hONtWUeTg7IxAmZtRX_D3OA7eCjzLrb9w"),
        "e": util.base64url.decode("AQAB"),
    ...
    {
      alg: "RS512",
      desc: "RSASSA-PKCS1-V_5 with SHA-512",
      key: {
        "kty": "RSA",
        "n": util.base64url.decode("tHxy-fcpeVkvyncpt0xiMRvmKkpLzvd58AFpjHc4fUAqPgIGB7W4TBwTLWFB86p70ZwWYAcZtlxDS5xIfTFSh5sQp9Fw6DK45Jsjqho4WSkx88vrHtHSgIYepyqN88TjOMZnMpArZe1MaWt8jMLq2zia8V07XZx8j33iIKB_cSUcyNaiFYX9xthxiMJT4fAP8mer0N2GMhQnZcucltV9aHN-aMs0srsFpoiWtGFVmW72wF5EAJ-lMConfiImADGnyO6kuhRSsz39_3u3Q7kpcj757-cmCp4pUKn4vROCt3v-Rj_OHmNG5hONtWUeTg7IxAmZtRX_D3OA7eCjzLrb9w"),
        "e": util.base64url.decode("AQAB"),
    ...
    {
      alg: "PS256",
      desc: "RSASSA-PKCS1-PSS with SHA-256",
      key: {
        "kty": "RSA",
        "n": util.base64url.decode("tHxy-fcpeVkvyncpt0xiMRvmKkpLzvd58AFpjHc4fUAqPgIGB7W4TBwTLWFB86p70ZwWYAcZtlxDS5xIfTFSh5sQp9Fw6DK45Jsjqho4WSkx88vrHtHSgIYepyqN88TjOMZnMpArZe1MaWt8jMLq2zia8V07XZx8j33iIKB_cSUcyNaiFYX9xthxiMJT4fAP8mer0N2GMhQnZcucltV9aHN-aMs0srsFpoiWtGFVmW72wF5EAJ-lMConfiImADGnyO6kuhRSsz39_3u3Q7kpcj757-cmCp4pUKn4vROCt3v-Rj_OHmNG5hONtWUeTg7IxAmZtRX_D3OA7eCjzLrb9w"),
        "e": util.base64url.decode("AQAB"),
    ...
    {
      alg: "PS384",
      desc: "RSASSA-PKCS1-PSS with SHA-384",
      key: {
        "kty": "RSA",
        "n": util.base64url.decode("tHxy-fcpeVkvyncpt0xiMRvmKkpLzvd58AFpjHc4fUAqPgIGB7W4TBwTLWFB86p70ZwWYAcZtlxDS5xIfTFSh5sQp9Fw6DK45Jsjqho4WSkx88vrHtHSgIYepyqN88TjOMZnMpArZe1MaWt8jMLq2zia8V07XZx8j33iIKB_cSUcyNaiFYX9xthxiMJT4fAP8mer0N2GMhQnZcucltV9aHN-aMs0srsFpoiWtGFVmW72wF5EAJ-lMConfiImADGnyO6kuhRSsz39_3u3Q7kpcj757-cmCp4pUKn4vROCt3v-Rj_OHmNG5hONtWUeTg7IxAmZtRX_D3OA7eCjzLrb9w"),
        "e": util.base64url.decode("AQAB"),
    ...
    {
      alg: "PS512",
      desc: "RSASSA-PKCS1-PSS with SHA-512",
      key: {
        "kty": "RSA",
        "n": util.base64url.decode("tHxy-fcpeVkvyncpt0xiMRvmKkpLzvd58AFpjHc4fUAqPgIGB7W4TBwTLWFB86p70ZwWYAcZtlxDS5xIfTFSh5sQp9Fw6DK45Jsjqho4WSkx88vrHtHSgIYepyqN88TjOMZnMpArZe1MaWt8jMLq2zia8V07XZx8j33iIKB_cSUcyNaiFYX9xthxiMJT4fAP8mer0N2GMhQnZcucltV9aHN-aMs0srsFpoiWtGFVmW72wF5EAJ-lMConfiImADGnyO6kuhRSsz39_3u3Q7kpcj757-cmCp4pUKn4vROCt3v-Rj_OHmNG5hONtWUeTg7IxAmZtRX_D3OA7eCjzLrb9w"),
        "e": util.base64url.decode("AQAB"),
